...
def get_blogs(url, headers):
    ...
    for i in range(1, blogs_number + 1):  # 如果是第一个，就保留第一个的选择器，如果第2及之后，就换
        if i == 1:
            ...
            user_infos = soup.select(
                '#pl_feedlist_index > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > a:nth-child(1)')
            publish_times = soup.select(
                '#pl_feedlist_index > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > a:nth-child(1)')
            blog_texts = soup.select(
                '#pl_feedlist_index > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > p:nth-child(3)')
            reposts = soup.select(
                '#pl_feedlist_index > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(1) > a:nth-child(1)')
            ...
            like_counts = soup.select(
                '#pl_feedlist_index > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(3) > a:nth-child(1) > button:nth-child(1) > span:nth-child(2)')
        else:
            blog_ids = soup.select('div.card-wrap:nth-child(' + str(i) + ')')
            user_infos = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > a:nth-child(1)')
            publish_times = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > a:nth-child(1)')
            blog_texts = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > p:nth-child(3)')
            reposts = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(1) > a:nth-child(1)')
            comments = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(2) > a:nth-child(1)')
            like_counts = soup.select('div.card-wrap:nth-child(' + str(
                i) + ') > div:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(3) > a:nth-child(1) > button:nth-child(1) > span:nth-child(2)')
        ...
        blog_id = re.findall('<div action-type="feed_list_item" class="card-wrap" mid="(.*?)">', blog_id,
                             re.S)  # 提取博文id，如['4809724744696284']
...
if __name__ == '__main__':
    ...
    parameters_one = ['&typeall=1', '&xsort=hot', '&scope=ori', '&vip=1', '&category=4',
                      '&viewpoint=1', ]  # 一级条件全选，热门，原创，认证用户，媒体，观点
    ...
    timescope = '2022-09-02-0:2022-09-06-23'  # 开始时间：结束时间，年-月-日-时，其中时是从0到23
    query = '中国'  # 关键词或话题
    ...
    base_url = 'https://s.weibo.com/weibo?q=' + query + parameters_one[one_type] + parameters_two[
        two_type] + '&timescope=custom:' + timescope + '&Refer=g'
    ...
    for page in range(1, page_number + 1):  # 开始爬取
        id_data, bid_data, uid_data, name_data, time_data, text_data, repost_data, comment_data, like_data = get_blogs(
            base_url + '&page=' + str(page), headers)  # 翻页操作
    ...
    a_list = [id_datas, bid_datas, uid_datas, name_datas, time_datas, text_datas, repost_datas, comment_datas,
              like_datas]
