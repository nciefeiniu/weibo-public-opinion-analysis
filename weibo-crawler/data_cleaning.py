...
def clean(line):
    ...
    rep = ['回复:', '回复的表态', '图片评论 ', '图片评论', '//:  ', '【】', '【', '】', '转发微博', '下午好', '下午好', '👍',
           '🤝', '。。', '外交部：', '信息发布微平台',
           '扩散', '信息发布的微平台', '🐮', '🙏', '🇨🇳', '👏', '❤️', '………', '信息传播微平台', '🐰', '...、、', '，，', '..',
           '💪', '🤓', '晚安吉祥！',
           '来互动喽', '来看看哦', '收藏了', '看一下。', '点个赞', '来看看哦', '我来看看你', '啊啊啊啊啊啊啊啊！',
           '嘿嘿嘿嘿嘿、嘿', '划重点！划重点！',
           '天啦噜', '⚕️', '👩', '转发', '🙃', '😇', '🍺', '🐂', '🙌🏻', '😂', '📖', '😭', '赞赞', '✧٩(ˊωˋ*)و✧', '🦐', '？？？？',
           '//', '😊', '💰', '😜', '😯',
           '(ღ˘⌣˘ღ)', '✧＼٩(눈౪눈)و/／✧', '传递信息微平台', '🌎', '传递新闻资讯~', '🍀', '传递有用的信息', '？？', '🐴',
           '扩散周知', '转！',
           '转发周知', '🌻', '🌱', '🌱', '🌻', '收藏转发～～～', '🙈', '优质内容', '信息发布微平台！！！', '(ง•̀_•́)ง！', '🉑️',
           '直播！', '💩', '信息发布微平台！',
           '🐎', '⊙∀⊙！', '🙊', '【？', '+1', '菲总统府：', '😄', '🙁', '早安', '午安', '晚安', '你想知道的都在这！', '👇🏻', '📚',
           '🙇', '收藏', '【《面对面》正在播出：！】',
           '🙋', '康康', '深夜好', '占个位置', '！！！！', '🎉', '＼(^▽^)／', '👌', '晚上好', '【最全解答！】', '🆒', '🏻', '上午好',
           '下午好', '晚上好', '深夜好',
           '🙉', '🎵', '🎈', '🎊', '0371-12345', '☕️', '🌞', '😳', '👻', '🐶', '👄', '\U0001f92e\U0001f92e', '😔', '＋1', '🛀', '🐸',
           '🐷', '新闻1》|？', '➕1',
           '🌚', '：：', '💉', '√', 'x', '！！！', '🙅', '♂️', '💊', '👋', 'o(^o^)o', 'mei\u2006sha\u2006shi', '💉', '😪', '早上好',
           '😱', '多互动', '\U0001f9a0',
           '🤗', '关注', '……', '(((╹д╹;)))', '⚠️', 'Ծ‸Ծ', '⛽️', '😓', '🐵', '了解', '关注热点，传递正能量',
           '传播法治正能量', '传播法治正能量~！',
           '传递法治力量', '传播法治正能量传播法治正能量', '信息发布微平', '🙄️', '已经', '8⃣️', '来串门', '互动来啦',
           '强者与弱者的分界就在于谁更愿意评论和点赞',
           '🌕', '新冠疫苗最快何时上市？8个最新权威问答来了！', '…', '😋', '[]', '[', ']', '→_→', '💞', '😨', '&quot;', '😁',
           'ฅ۶•ﻌ•♡', '😰', '🎙️',
           '🤧', '😫', '(ง•̀_•́)ง', '😁', '✊', '🚬', '😤', '👻', '😣', '：', '😷', '(*^▽^)/★*☆', '🐁', '🐔', '😘', '🍋', '(✪▽✪)',
           '转收', '马了', '(❁´ω`❁)', '1⃣3⃣', '(^_^)／', '☀️',
           '🎁', '😅', '🌹', '🏠', '→_→', '🙂', '✨', '❄️', '•', '🌤', '💓', '🔨', '回复的表态', '👏', '的表态', '趣图评论',
           ...
           '😊', '👆', '💤', '😘', '😊', '😴', '😉', '🌟', '♡♪..𝙜𝙤𝙤𝙙𝙣𝙞𝙜𝙝𝙩•͈ᴗ•͈✩‧₊˚', '👪', '💰', '😎', '🍀', '🛍', '🖕🏼', '😂',
           '(✪▽✪)', '🍋', '🍅', '👀', '♂️', '🙋🏻', '✌️', '🥳', '￣￣)σ',
           '😒', '😉', '🦀', '💖', '✊', '💪', '关注热点，传递正能量', '🙄', '🎣', '🌾', '✔️', '踩踩', '欢迎互动',
           '感谢分享，欢迎回访', '😡', '😌', '🔥', '❤',
           '🏼', '热点', '热点，传递法治资讯', '扩转周知', '🤭', '谢谢', '热点，传递正能量',
           '立足检察职能以检察视角各界动态', '发布的信息',
           '🌿', '丨', '✅', '🏥', 'ﾉ', '☀', '5⃣⏺1⃣0⃣', 'te\u2006s\u2006t', '世卫组织国药疫苗易储存，', '法治ing', '🚣', '🎣',
           '🤯', '🌺', '周三快乐！',
           '急转', '🌸', '周知', '午餐快乐！', '推荐!', '加v', '博主v',
           '设置闹钟，每天只需30秒点亮闪电，看教程下载注册，有不懂的微博私信我',
           '注册挖矿', '到时卖我', '大写＋小写＋数学', '已加', '来了', '转扩', '蔡徐坤', '！！', '同问', '唉。',
           '传播正能量', '，传播正能量'
